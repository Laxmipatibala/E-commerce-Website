...
function BooksAndHobbies() {
    const { products } = useContext(ProductContext);
    const categoryProducts = products.filter(p => p.category === "BooksAndHobbies");
            ...
            <div className="pt-40 px-8 pb-10 min-h-screen bg-gray-50">
                ...
                {categoryProducts.length === 0 ? (
                    <div className="flex flex-col items-center justify-center mt-20">
                        ...
                        <p className="text-xl font-bold text-gray-400">No books & hobbies items found yet.</p>
                    </div>
                ) : (
...
export default BooksAndHobbies;
